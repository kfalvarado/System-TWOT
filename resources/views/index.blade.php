    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#events">Más de Nosotros</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            ...
            <p class="fst-italic"><strong>
              ...
              por un equipo fresco, vibrante y energético con talento creativo y estándares de calidad muy alto
            ...
            <p class="fst-italic"><strong>
              ...
              Para la realización de este proyecto nos hemos apoyado en herramientas PHP, JAVASCRIPT, CSS, 
              BOOSTRAP, HTML, MSQL, ETC para el desarrollo e integración del sitio web.
            </p></strong>
          </div>
        </div>
              ...
              <div class="row event-item">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                  ...
                  <p>
                    ...
                    usted requiere, para ello contamos con un equipo capacitado e idóneo en el área; 
                    los cuales son el eje principal de nuestro trabajo.
                    Es así, que The World Of Tools le ofrece el mejor servicio para que usted
                  ...
                  <p>
                    Posesionarnos como una empresa Líder en el desarrollo web,
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                  ...
                  <p>
                    Nuestra prioridad es mantener la confiabilidad y la satisfacción de nuestros clientes, 
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                  ...
                  <ul>
                    <li><i class="bi bi-check-circled"></i>Permanecer en una mejora continua para así mantener nuestro producto de alta calidad y desempeño.</li>
                    <li><i class="bi bi-check-circled"></i>Comprometiéndonos a estar a la vanguardia con nuestro producto a las nuevas tendencias.  </li>
                    <li><i class="bi bi-check-circled"></i>Ser los mejores en la competencia en desarrollo de tecnología web y plataformas virtuales.</li>
                  </ul>
                </div>
              </div>
            </div><!-- End testimonial item -->
